...
//                location, System.currentTimeMillis());
        ...
        String str1 = data.getString(INDEX_SHORT_DESC);
        String str2 = data.getString(INDEX_MAX_TEMP);
        String str3 = data.getString(INDEX_MIN_TEMP);
        data.close();
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setTextViewText(R.id.tv_text, str2 + ": " + str1);

            // Create an Intent to launch MainActivity
            Intent launchIntent = new Intent(this, MyStocksActivity.class);
            PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, launchIntent, 0);
            views.setOnClickPendingIntent(R.id.iv_stock_symbol, pendingIntent);
